...
//     resume: null,
//   });
//   const [isFormRecaptchaVerified, setIsFormRecaptchaVerified] = useState(false);
...
//   const onChange = () => {
//     setIsFormRecaptchaVerified(true);
//   };
...
//                 type="submit"
//                 disabled={!isFormRecaptchaVerified}
//               >
      ...
      <form id="career_form" onSubmit={handleSubmit}>
        <div className="row career-contact rounded pb-3">
          ...
          <div className="col-12 col-md-6">
            ...
            <ReCAPTCHA className="mt-2" sitekey={googleCaptcha} onChange={onChange} />
            <div className="form-group">
              <label htmlFor="attach_document">
                Attach your resume <span style={{ color: "red" }}>*</span>
              </label>
