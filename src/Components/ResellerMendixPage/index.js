      ...
      <>
        ...
        {loading ? (
          ...
          <div className="mendix-main-container container-fluid">
            ...
            <div className="row">
              <div className="reseller-mendix-side-description col-12 col-md-6">
                <div className="mendix-card-description">
                  ...
                  <p className="mendix-card-description-para">
                    ...
                    space since 2019 even before Siemens acquisition of
                    Polarion.
                  </p>
                  <p className="mendix-card-description-para">
            ...
            <div className="reseller-mendix-row row p-3">
              ...
              <div className="reseller-mendix-side-description col-md-6 col-12">
                <div className="mendix-card-description">
                  <h1 className="mendix-card-description-heading">
                    LABYRINTH OFFERING
                  </h1>
