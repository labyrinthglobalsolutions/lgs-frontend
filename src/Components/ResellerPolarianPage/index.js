            ...
            <div className="siemens-resellar-polarian-hover-card col-12 col-md-6">
              ...
              <div className="resellar-polarian-card-description">
                ...
                <ul className="labyrinth-offering-unorderedlist-contianer">
                  ...
                  <li>
                    Adopt modern agile techniques at once or incrementally with
                    out of the box project templates that can be adjusted to
                    your needs
                  </li>
                  <li>
                    Optimize planning, prioritization and release predictability
                    via flexible planning and real-time reporting
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <div className="polarian-card">
                    ...
                    <div className="content">
                      ...
                      <p className="polarian-resellar-card-para">
                        ...
                        companies and helped them with FDA 21 Part 11, Part 820,
                        IEC 62304, ISO 14971 compliance, saved their overall
                        cost by 40% to 50%.
                      </p>
                    </div>
                  </div>
